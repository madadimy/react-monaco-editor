...
>>>>>>> f72bbf3c4410a0e9a61d4ebf112abd736bb1d445
  ...
  _createClass(MonacoEditor, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (prevProps.options !== this.props.options) {
        this.afterViewInit();
        var child = document.getElementsByClassName('monaco-editor')[0];
        var parend = document.getElementsByClassName('react-monaco-editor-container')[0];
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      console.log(nextProps.value == this.props.value, nextProps.theme == this.props.theme, nextProps.options.fontSize == this.props.options.fontSize);

      if (nextProps.value == this.props.value && nextProps.theme == this.props.theme && nextProps.options.fontSize == this.props.options.fontSize) {
